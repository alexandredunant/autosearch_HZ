...
# ============================================================
# Add next features here:
# 'precipitation_23d_sum', 'precipitation_24d_sum', ...
FEATURE_NAMES: list[str] = ['slope', 'elevation', 'distroads', 'flammability', 'northness', 'treecoverdensity', 'tri', 'walking_time_to_road', 'precipitation_1d_sum', 'precipitation_2d_sum', 'walking_time_to_bldg', 'walking_time_to_elec_infra', 'precipitation_3d_sum', 'precipitation_4d_sum', 'precipitation_5d_sum', 'precipitation_6d_sum', 'precipitation_7d_sum', 'precipitation_8d_sum', 'precipitation_9d_sum', 'precipitation_10d_sum', 'precipitation_11d_sum', 'precipitation_12d_sum', 'precipitation_13d_sum', 'precipitation_14d_sum', 'precipitation_15d_sum', 'precipitation_16d_sum', 'precipitation_17d_sum', 'precipitation_18d_sum', 'precipitation_19d_sum', 'precipitation_20d_sum', 'precipitation_21d_sum', 'precipitation_22d_sum', 'precipitation_23d_sum', 'precipitation_25d_sum', 'precipitation_26d_sum', 'precipitation_27d_sum', 'precipitation_28d_sum', 'precipitation_29d_sum', 'precipitation_30d_sum', 'precipitation_31d_sum', 'precipitation_32d_sum', 'precipitation_33d_sum', 'precipitation_34d_sum', 'precipitation_35d_sum']
# ============================================================
